                ...
                <nav class="navbar navbar-expand-lg navbar-light py-2 px-0 navbar-container">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/menu" class="nav-item nav-link active">Products</a>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 pb-4 product-card">
                                <div class="card product-item border-0 mb-4 h-100">
                                    ...
                                    <div class="card-footer d-flex justify-content-between bg-light border">
                                        <a href="<?php echo BASE_URL . 'Acc/' . $pr['id']; ?>" class="add-to-cart-btn">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function performSearch(query) {
                ...
                searchTimeout = setTimeout(() => {
                    ...
                    // Show message if no products match in main grid
            ...
            // Clear search when refresh button is clicked
